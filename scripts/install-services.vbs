...
UAC.ShellExecute "nssm.exe", "install DayLoop-Node ""D:\Program Files\nodejs\node.exe"" ""D:\02.Personal\04..代码\Code\DayLoop\backend\src\index.js""", "D:\02.Personal\04..代码\Code\DayLoop\scripts", "runas", 0
WScript.Sleep 1000
UAC.ShellExecute "nssm.exe", "set DayLoop-Node AppDirectory ""D:\02.Personal\04..代码\Code\DayLoop\backend""", "", "runas", 0
WScript.Sleep 500
...
WScript.Sleep 500
UAC.ShellExecute "nssm.exe", "set DayLoop-Node AppStdout ""D:\02.Personal\04..代码\Code\DayLoop\backend\logs\stdout.log""", "", "runas", 0
WScript.Sleep 500
UAC.ShellExecute "nssm.exe", "set DayLoop-Node AppStderr ""D:\02.Personal\04..代码\Code\DayLoop\backend\logs\stderr.log""", "", "runas", 0
WScript.Sleep 500

' Install .NET backend service
UAC.ShellExecute "nssm.exe", "install DayLoop-DotNet ""C:\Program Files\dotnet\dotnet.exe"" ""run --urls http://0.0.0.0:5000""", "D:\02.Personal\04..代码\Code\DayLoop\scripts", "runas", 0
WScript.Sleep 1000
UAC.ShellExecute "nssm.exe", "set DayLoop-DotNet AppDirectory ""D:\02.Personal\04..代码\Code\DayLoop\backend-dotnet""", "", "runas", 0
WScript.Sleep 500
...
WScript.Sleep 500
UAC.ShellExecute "nssm.exe", "set DayLoop-DotNet AppStdout ""D:\02.Personal\04..代码\Code\DayLoop\backend-dotnet\logs\stdout.log""", "", "runas", 0
WScript.Sleep 500
UAC.ShellExecute "nssm.exe", "set DayLoop-DotNet AppStderr ""D:\02.Personal\04..代码\Code\DayLoop\backend-dotnet\logs\stderr.log""", "", "runas", 0
WScript.Sleep 500
